...
public class RedisUtils implements InitializingBean {
    ...
    /**
     * setT: <br/> 设置key-value对，值类型为Object,带过期时间<br/>
     *
     * @author liujie
     */
    ...
    /**
     * getJedisPoolStatus: <br/> 获取当前连接池状态<br/>
     *
     * @author liujie
     */
    ...
    /**
     * zremrangeByScore: <br/> 删除zset类型score在指定范围内的元素<br/>
     */
